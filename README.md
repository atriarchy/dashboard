...
2. Run `./start-dev.sh` to start a local PostgreSQL database, and an S3 bucket with MinIO.
...
4. Push the database schema to the new database using `pnpm db:generate`.
